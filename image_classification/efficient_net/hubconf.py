    ...
    def _model_fn(num_classes=1000, in_channels=3, pretrained="imagenet"):
        ...
        Args:
            ...
            pretrained (str, optional): One of [None, 'imagenet', 'advprop']
                ...
                If 'imagenet', weights trained on imagenet dataset are loaded.
                If 'advprop', weights trained using adversarial training called
                advprop are loaded. It is important to note that the
                preprocessing required for the advprop pretrained weights is
