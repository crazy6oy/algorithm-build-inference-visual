...
def run(target="cuda", print_log=True, callback_fn=lambda output: None):
    ...
    if SPLIT_GRAPH:
        for i in range(11):
            ...
            model_path = (
                f"{QUANTIZE_RESULTS}/quantize_results_{i}/quantize_eval_model.pb"
            )
    ...
    while True:
            ...
            if SPLIT_GRAPH:
                ...
                for i, sess in enumerate(sessions):
                    ...
                    if i == 0:
                        ...
                        out_node = (
                            f"MobilenetV2/expanded_conv_shift_{i}/prev_conv_output:0"
                        )
                        layer_name = (
                            f"expanded_conv_shift_{i-1}"
                            if i > 1
                            else f"expanded_conv_shift"
                        )
                        feed_dict[f"MobilenetV2/{layer_name}/input:0"] = resid_in
                        feed_dict[
                            f"MobilenetV2/{layer_name}/shift_concat_input:0"
                        ] = shift_concat_in
                ...
                out_nodes = [
                    ...
                    "MobilenetV2/expanded_conv_shift/shift_split_buffer_output:0",
                    "MobilenetV2/expanded_conv_shift_1/shift_split_buffer_output:0",
                    "MobilenetV2/expanded_conv_shift_2/shift_split_buffer_output:0",
                    "MobilenetV2/expanded_conv_shift_3/shift_split_buffer_output:0",
                    "MobilenetV2/expanded_conv_shift_4/shift_split_buffer_output:0",
                    "MobilenetV2/expanded_conv_shift_5/shift_split_buffer_output:0",
                    "MobilenetV2/expanded_conv_shift_6/shift_split_buffer_output:0",
                    "MobilenetV2/expanded_conv_shift_7/shift_split_buffer_output:0",
                    "MobilenetV2/expanded_conv_shift_8/shift_split_buffer_output:0",
                    "MobilenetV2/expanded_conv_shift_9/shift_split_buffer_output:0",
                ]
        ...
        cv2.putText(
            label,
            "{:.1f} Vid/s".format(1 / current_time),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="cuda",
        nargs="?",
        help="Target for compilation. If set to 'llvm -target={LLVM_TARGET}', cross compilation is assumed. See run() function for additional details.",
    )
