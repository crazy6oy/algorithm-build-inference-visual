...
def main():
    ...
    trainSequenceJsonPath = r"D:\work\dataSet\CVS\score\v1\sequence2_24_8_1.json"
    valSequenceJsonPath = (
        r"D:\work\dataSet\CVS\score\v1\sequenceTest2_24_8_1(oldFormat).json"
    )
    args.modality = "AddFeature_1"
    addFeatureNum = int(args.modality.split("_")[-1])

    logFileName = "CVSAddMask"
    ...
    if addFeatureNum > 0:
        model.base_model.conv1 = torch.nn.Conv2d(
            3 + addFeatureNum, 64, (3, 3), (2, 2), (3, 3), bias=False
        )
