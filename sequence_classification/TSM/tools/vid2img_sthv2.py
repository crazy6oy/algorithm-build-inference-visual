...
NUM_THREADS = 100
VIDEO_ROOT = (
    "/ssd/video/something/v2/20bn-something-something-v2"  # Downloaded webm videos
)
...
def extract(video, tmpl="%06d.jpg"):
    ...
    cmd = (
        'ffmpeg -i "{}/{}" -threads 1 -vf scale=-1:256 -q:v 0 "{}/{}/%06d.jpg"'.format(
            VIDEO_ROOT, video, FRAME_ROOT, video[:-5]
        )
    )
    os.system(cmd)
