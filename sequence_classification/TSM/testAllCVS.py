...
def main():
    ...
    sequenceJsonPath = (
        r"D:\work\dataSet\CVS\score\v1\10\sequenceAllNoPublic2_24_8_4(oldFormat).json"
    )
    recordJson = "./outputCVSIRegion24_8_4.json"
    num_class = 0
    for rule in dictCategories:
        num_class += len(dictCategories[rule])
    args.resume = r"D:\work\dataSet\CVS\score\v1\10\finish\CVSOnlyCVSINoPublicRegion24_8_4MAPBest.pth.tar"
